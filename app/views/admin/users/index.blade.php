...
<table class="full-width">
	<thead>
		<tr>
			...
			<th class="text-center">@lang('gorilla.users.fields.enabled')</th>
			<th class="text-center">@lang('gorilla.users.fields.last_login')</th>
			<th class="text-center">@lang('gorilla.users.fields.posts')</th>
			<th></th>
		</tr>
	</thead>
	<tbody>
